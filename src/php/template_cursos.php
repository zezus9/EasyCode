<?php
    ...
    while ($curso = mysqli_fetch_array($buscaCurso)){
                ...
                <div class='imagem-header'>
                    <div class='area-imagem'>
                        <div class='align-self-center'>
                            <h1 class='text-uppercase Lovelofont'>$curso[linguagem]</h1>
                            <p>$curso[desc_breve]</p>
                        </div>
                        <div class='col-auto d-none d-lg-block m-6'>
                            <img src='../assets/img/logo_cursos/menores/$curso[logo]' width='300px'/>
                        </div>
                    </div>
            </header>
        ";
        ...
        $arquivo = fopen ("../cursos/$curso[linguagem]/descricao.txt", 'r');
        echo "<p>";
        while(!feof($arquivo)) {
        ...
        "
                                    ...
                                    <div>
                                        <div class='d-flex d-inline-block m-1'>
                                            <div class='d-flex align-center col-md-3 col-sm-6'>
                                                <img src='../assets/img/Avatares/$curso[avatar]' width='100%'>
                                            </div>
                                            <div class='col-md-8  col-sm-6'>
                                                <div class='h-25 d-flex justify-content-start align-items-end'>
                                                    <h5 class='text-center'>$curso[nome_prof]</h5>
                                                </div>
                                    ...
                                    <h4>Duração</h4>
                                    <p>O curso terá duração de $curso[duracao] horas.</p>
                                    <h4>Fases</h4>
                                    <p>Apresentará $curso[fase] fases.</p>
                                    <h4>Conteúdo a ser aprendido</h4>
        ";

        $arquivo = fopen ("../cursos/$curso[linguagem]/conteudo.txt", 'r');
        echo "<p>";
        while(!feof($arquivo)) {
            $linha = fgets($arquivo, 1024);
            echo $linha.'<br />';
